...
import { Ai, BaseAiTextGenerationModels, RoleScopedChatInput } from "@cloudflare/workers-types"
...
export async function autoTrimTools(tools: AiTextGenerationToolInputWithFunction[], ai: Ai, model: BaseAiTextGenerationModels, messages: RoleScopedChatInput[]) {
